...
contract tx_mapping is Ownable{
    ...
    function update_addr(address _address_wallet, uint8 _kyc_state, string memory _tx_done, string memory _usdt_spent, string memory _last_update) public onlyOwner() {
