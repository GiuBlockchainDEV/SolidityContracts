...
contract ERC20 is Context, IERC20 {
    ...
    function balanceOfERC20(address account) public view virtual override returns (uint256) {
...
contract forint_anniversary is ERC721A, ERC20, Ownable, ReentrancyGuard {
    ...
    address public forint_address = 0x5CEeBB0947d58Fabde2fc026Ffe4B33ccFE1bA8B;
    ...
    function getForintBalance(address _sender) public view returns (uint256) {
        return ERC20(forint_address).balanceOfERC20(_sender);}
    ...
    function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        require(getForintBalance(_msgSender()) > 0, "You don't have 4INT");
