...
contract car is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public nominalPriceNFT = 100*(10**18);
    uint256 public priceNFT = 99*(10**18);
    string public hiddenMetadataUri = "ipfs://---/hidden.json";

    string public _tokenName = "FIAT 500X";
    string public _tokenSymbol = "F500X";
    ...
    function setAddressStake(address _addressStake) public onlyOwner {
