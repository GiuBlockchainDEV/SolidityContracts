...
contract Mili is ERC20, Ownable(msg.sender) {
    // Lubrication prevents any wallet receiving more than 1% of Token in the opening days.
    bool public lubricating = true;
    address public liquidityPool;

    // Mint the totalSupply (69.420 T) to the deployer
    constructor() ERC20("Mili", "MILI") {
    ...
    function _update(
        ...
        if (lubricating && from != owner() && to != liquidityPool) {
            ...
            require(
                ...
                "Just getting warmed up, limit of 1% of Mili can be move until Lubrication is complete!"
            );
        }
    }
