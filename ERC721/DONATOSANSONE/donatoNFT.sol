...
contract portraits is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public costPublicSale = 0.2 ether;
    ...
    string public tokenName = "PORTRAITS NFT COLLECTION";
    string public tokenSymbol = "PNFTC";
    uint256 public maxSupply = 23;
    uint256 public mintableSupply = 23;
    uint256 public maxMintAmountPerTx = 23;
    string public hiddenMetadataUri = "ipfs://QmbfoeMn82yzZwoEoYrxTZo7JaPrPa2BYgE6684mfYt6JM/hidden";
